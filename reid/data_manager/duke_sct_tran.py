...
class DukeSCTTran(object):

    dataset_dir = 'duke_sct_tran'

    def __init__(self, root='data', **kwargs):
        self.name = 'duke_sct_tran'
    ...
    def _process_dir(self, dir_path, relabel=False):
        ...
        fake_pattern = re.compile(r'([-\d]+)_c(\d)_f[\d]+_fake_\dto(\d)')
        ...
        for img_path in img_paths:
            ...
            dataset.append((img_path, pid, camid, if_real, fake_camid))
